...
change_hotkey_desc = Ändern Sie den Hotkey, um Aktionen zu starten und zu stoppen
...
milliseconds_warning = 0ms wird nicht empfohlen
...
back = Zurück
forward = Vorwärts
scroll_up = Zurückscrollen
scroll_down = Scrollen nach unten
...
save = Speichern
reload = Neu laden
reload_tooltip = Das Skript von der Festplatte neu laden